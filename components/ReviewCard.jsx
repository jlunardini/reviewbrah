            ...
            <div className="flex flex-row items-center gap-2 mt-4">
              {review.score < 0 ? (
                <>
                  <div className="flex flex-row items-center">
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className={`${review.score <= -2 ? "fill-yellow-300" : "hover:fill-yellow-300"
                    ...
                    <svg
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className={`${review.score <= -1 ? "fill-yellow-300" : ""
                ...
                <div className="flex flex-row-reverse items-center">
                  ...
                  <svg
                    className={`${review.score >= 1 ? "fill-yellow-300" : "peer-hover:fill-yellow-300"
